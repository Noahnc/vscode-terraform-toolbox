...
import * as spaceliftTreeView from "./view/TreeDataProvider/spacelift/spacelift_tree_provider";
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  spacectlInit(settings).then(([spaceliftClient, spacectlInstance, tenantID, authenticationHandler]) => {
    ...
    spaceliftTreeView.activate(spaceliftClient, cst.COMMAND_REFRESH_SPACELIFT_STACKS_VIEW);
